		...
		<form action="" method="POST" class="login-email">
			<div class="form-row">
				...
				<div class="input-group col-12 col-sm-9">
					<input type="text" placeholder="Account No" name="faccno" value="<?php echo $ans['account_no']; ?>" disabled  style="background-color: white; opacity: 0.8; color: black; border-color: #a29bfe;">
				</div>
			</div>
